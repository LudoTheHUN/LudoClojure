(defproject LudoClojure "1.0.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.2.1"]
				 ...
				 ;;Note including calx + gloss cause error "Exception in thread "main" java.lang.SecurityException: Invalid signature file digest for Manifest main attributes, new to remove manualy both non manifest files"
  :jvm-opts ["-Xmx1300m"]
